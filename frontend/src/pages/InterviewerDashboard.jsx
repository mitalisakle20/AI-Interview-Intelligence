                    ...
                    <div className="flex flex-col items-end">
                        {isGenerating ? (
                            ...
                            <div className="flex items-center gap-3">
                                <PdfDownloadButton targetId="brief-content" filename={`${session.companyName.replace(/\s+/g, '_')}_Brief.pdf`} />
                                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-50 justify-center text-green-700 font-semibold text-sm ring-1 ring-green-200">
